...
export default defineConfig({
  ...
  rules: {
    ...
    "linteffect/no-runpromise-in-non-async-test-body": "error",
    "linteffect/require-effect-flip-for-error-test": "error",
    "linteffect/no-test-mock-layer-when-default-available": "error",
